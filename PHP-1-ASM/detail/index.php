            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    if ($user[0]['role'] == 'admin') {
                        echo '<li class="nav-item"><a class="nav-link" href="../admin/index.php">Manage</a></li>';
                    }
                    ?>
    ...
    <section class="py-5">
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../admin/uploads/<?php echo $product[0]['avatar'] ?>" style="max-width: 500px" alt="..." /></div>
                <div class="col-md-6">
                    <!-- <div class="small mb-1">Category: </div> -->
                    <h1 class="display-5 fw-bolder"><?php echo $product[0]['name'] ?></h1>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">$<?php echo $product[0]['price'] ?></span>
                        <span>$40.00</span>
                    </div>
